        ...
        <div class="page-content">
            ...
            <section id="video" class="content-section">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="box-video">
                            <div class="bg-video" style={{backgroundimage: "url(https://unsplash.imgix.net/photo-1425036458755-dc303a604201?fit=crop&fm=jpg&q=75&w=1000)"}}>
                            ...
                            <section id="first-tab-group" class="tabgroup">
                                ...
                                <div id="tab3">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="item">
                                                <img src="assets/mg/blog_3.jpg" alt="" />
                                                <div class="text-content">
                                                    <h4>Integer ultrices augue</h4>
            ...
            <p>Copyright &copy; 2021 Company Name: GreetLabs Pvt.Ltd/Design: Swati
                             (Full Stack Python Developer)</p>
            </section> */}
        </div>
            </div>
        );    
